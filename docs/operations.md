...
`raster-dev-release-guard` is centered on developer tools work in Rust. The technical target is: Build a Rust toolkit that studies release behavior through layout fixtures, with stable geometry snapshots and offline replay mode.
...
The score is deterministic. The current threshold is 184. Risk has a penalty of 7, latency has a penalty of 4, and weight contributes a bonus of 4.
