"""Regression checks for the raster-dev-release-guard casebook."""
...
from casebook.harness import assert_expected, raster_dev_release_guard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(raster_dev_release_guard_summary(), assert_expected())
